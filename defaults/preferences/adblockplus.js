...
pref("extensions.adblockplus.subscriptions_fallbackurl", "https://adblockplus.org/getSubscription?url=%SUBSCRIPTION%&downloadURL=%URL%&channelStatus=%CHANNELSTATUS%&responseStatus=%RESPONSESTATUS%");
